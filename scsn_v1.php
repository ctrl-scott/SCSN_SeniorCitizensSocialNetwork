...
SCSN – Senior Citizens Social Network
– civic / support use, not a dating app, not a real emergency service.

Changes from bitter_v2.php are minimal but add:

New naming and copy for seniors / civic use.

A flip-phone keypad panel with big 1-2-3 buttons:
...
Posts table now has a kind column: normal, help, 911, emergency_address.

Quick-post API uses the same posts-create endpoint with an extra kind field.

Strong disclaimer that this is educational only and does not contact 911 or any agency.

⚠️ This is a teaching prototype. In real life, older adults are advised to call 911 directly and work with caregivers and local services when planning for emergencies. 
Ready.gov
*/
?>
<?php
...
/*
  ...
  Web-first educational social application for older adults.
  This version uses PHP + PDO with SQLite or MariaDB for storage and
  adds a flip-phone-style keypad with three quick actions:
  ...
  IMPORTANT:
  - This prototype DOES NOT contact 911, law enforcement, or social services.
  - It only writes flagged posts into a local database feed for training.
  - Real emergencies require calling 911 or local emergency services directly.
...
function scsn_get_pdo(): PDO
{
    ...
    if (SCSN_DB_DRIVER === 'sqlite') {
        ...
        $pdo = new PDO($dsn);
        // Enable foreign keys, as recommended in SQLite docs.
...
/**
 * Create tables if they do not exist and seed a default senior user.
 * Uses InnoDB for MariaDB for transactional safety and foreign keys.
 */
function scsn_bootstrap_schema(PDO $pdo): void
{
    ...
    // Seed default senior user if table is empty
 ...
 *   { "body": "...", "kind": "normal|help|911|emergency_address" }
 */
function scsn_api_create_post(): void
{
    ...
    // constrain kind to known values for clarity
...
<body>
    ...
    <aside class="sidebar" aria-label="Sidebar">
      <section class="sidebar-panel" aria-label="User information">
        ...
        <div class="user-summary">
          ...
          <p id="currentUserBio">
            Practicing simple, low-click communication for older adults. This demo does not contact emergency services.
          </p>
      ...
      <section class="sidebar-panel" aria-label="Menu">
        ...
        <small style="margin-top:6px; display:block; color:var(--text-muted);">
          This prototype stores posts in a local SQLite or MariaDB database through PDO.
          It is for training and planning only and does not replace 911.
        </small>
      </section>
    </aside>
      ...
      <div class="feed-inner-frame">
        <section class="highlighted" aria-label="Highlighted content">
          ...
          <div class="highlighted-body" id="highlightedBody">
            Welcome to the Senior Citizens Social Network (SCSN). This feed is for civic and safety support
            conversations. For real emergencies, always call 911 or your local emergency number.
          </div>
        </section>
        ...
        <!-- Flip-phone style keypad for quick posts -->
        <section class="phone-panel" aria-label="Flip phone quick actions">
          <strong>Flip-Phone Quick Actions (training only)</strong>
          <small>
            These buttons simulate a simple 1-2-3 keypad for older adults who use basic phones.
            They create clearly labeled posts in the feed but do not contact 911.
          </small>
          ...
          <small>
            1 = Post “Help” to network · 2 = Flag a “911 Alert” message · 3 = Post “Emergency and Address” message
          </small>
        </section>
  ...
  <footer>
    ...
    <ol>
      <li>
        PHP Group. (2024).
        <em>PHP manual: PDO</em>. https://www.php.net/manual/en/book.pdo.php :contentReference[oaicite:1]{index=1}
      </li>
      <li>
        SQLite Consortium. (2025).
        <em>PRAGMA foreign_keys</em>. SQLite documentation. https://sqlite.org/pragma.html :contentReference[oaicite:2]{index=2}
      </li>
      <li>
        MariaDB Foundation. (2025).
        <em>InnoDB storage engine introduction</em>. https://mariadb.com/docs/server/server-usage/storage-engines/innodb/ :contentReference[oaicite:3]{index=3}
      </li>
      <li>
        Ready.gov. (2025, February 5).
        <em>Older adults: Disaster preparedness guide</em>. U.S. Department of Homeland Security. https://www.ready.gov/older-adults :contentReference[oaicite:4]{index=4}
      </li>
      <li>
        American Red Cross. (2025).
        <em>Emergency preparedness for older adults</em>. https://www.redcross.org/get-help/how-to-prepare-for-emergencies/older-adults.html :contentReference[oaicite:5]{index=5}
      </li>
      <li>
        OpenAI. (2025).
        <em>SCSN – Senior Citizens Social Network design conversation</em>
        (ChatGPT conversation with Scott Owen, November 3, 2025).
      </li>
    </ol>
  </footer>

  <script>
    // Client-side logic for SCSN.
    // Retrieves posts from PHP JSON endpoints and supports quick keypad posts.
    ...
    function renderFeed(posts) {
      ...
      posts.forEach((post, index) => {
        ...
        const isEmergency = post.kind === "help" ||
                            post.kind === "911" ||
